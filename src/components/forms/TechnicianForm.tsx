...
export const TechnicianForm: React.FC<TechnicianFormProps> = ({
  ...
  // État pour stocker les sociétés récupérées depuis l'API
  ...
  // On utilise la société par défaut récupérée si disponible
  ...
  // Met à jour companyId si ce champ n'est pas défini et que des sociétés ont été chargées
  useEffect(() => {
